...
export const s3Config = {
  ...
  baseUrl: `https://${process.env.AWS_S3_BUCKET || process.env.NEXT_PUBLIC_AWS_S3_BUCKET}.s3.${process.env.AWS_REGION || process.env.NEXT_PUBLIC_AWS_REGION}.amazonaws.com`
};
