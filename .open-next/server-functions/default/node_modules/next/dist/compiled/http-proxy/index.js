 ...
 */
e.exports=r(763)},763:(e,t,r)=>{var o=r(458).Server;function s(e){return new o(e)}o.createProxyServer=s,o.createServer=s,o.createProxy=s,e.exports=o},341:(e,t,r)=>{var o=t,s=r(310),n=r(85),i=/(^|,)\s*upgrade\s*($|,)/i,a=/(^|,)\s*transfer-encoding\s*($|,)/i,c=/^https|wss/;function h(e){return!!~e.indexOf(":")}o.isSSL=c,o.setupOutgoing=function(e,t,r,u){e.port=t[u||"target"].port||(c.test(t[u||"target"].protocol)?443:80),["host","hostname","socketPath","pfx","key","passphrase","cert","ca","ciphers","secureProtocol"].forEach((function(r){e[r]=t[u||"target"][r]})),e.method=t.method||r.method,e.headers=Object.assign({},r.headers),t.headers&&Object.assign(e.headers,t.headers),t.auth&&(e.auth=t.auth),t.ca&&(e.ca=t.ca),c.test(t[u||"target"].protocol)&&(e.rejectUnauthorized=void 0===t.secure||t.secure),e.agent=t.agent||!1,e.localAddress=t.localAddress,e.headers=e.headers||{};var p=Object.keys(e.headers).some((function(t){return"transfer-encoding"===t.toLowerCase()&&void 0!==e.headers[t]}));(p||"string"==typeof e.headers.connection&&a.test(e.headers.connection))&&(e.headers.connection="close"),e.agent||"string"==typeof e.headers.connection&&i.test(e.headers.connection)||(e.headers.connection="close");var f=t[u||"target"],d=f&&!1!==t.prependPath&&f.path||"",l=t.toProxy?r.url:s.parse(r.url).path||"";return l=t.ignorePath?"":l,e.path=o.urlJoin(d,l),t.changeOrigin&&(e.headers.host=n(e.port,t[u||"target"].protocol)&&!h(e.host)?e.host+":"+e.port:e.host),e},o.setupSocket=function(e){return e.setTimeout(0),e.setNoDelay(!0),e.setKeepAlive(!0,0),e},o.getPort=function(e){var t=e.headers.host?e.headers.host.match(/:(\d+)/):"";return t?t[1]:o.hasEncryptedConnection(e)?"443":"80"},o.hasEncryptedConnection=function(e){return Boolean(e.connection.encrypted||e.connection.pair)},o.urlJoin=function(){var e,t=Array.prototype.slice.call(arguments),r=t.length-1,o=t[r].split("?");return t[r]=o.shift(),(e=[t.filter(Boolean).join("/").replace(/\/+/g,"/").replace("http:/","http://").replace("https:/","https://")]).push.apply(e,o),e.join("?")},o.rewriteCookieProperty=function e(t,r,o){return Array.isArray(t)?t.map((function(t){return e(t,r,o)})):t.replace(new RegExp("(;\\s*"+o+"=)([^;]+)","i"),(function(e,t,o){var s;if(o in r)s=r[o];else{if(!("*"in r))return e;s=r["*"]}return s?t+s:""}))}},458:(e,t,r)=>{var o=e.exports,s=r(310).parse,n=r(993),i=r(685),a=r(687),c=r(101),h=r(761);function u(e){return function(t){return function(r,o){var n,i,a="ws"===e?this.wsPasses:this.webPasses,c=[].slice.call(arguments),h=c.length-1;"function"==typeof c[h]&&(i=c[h],h--);var u=t;if(c[h]instanceof Buffer||c[h]===o||(u=Object.assign({},t),Object.assign(u,c[h]),h--),c[h]instanceof Buffer&&(n=c[h]),["target","forward"].forEach((function(e){"string"==typeof u[e]&&(u[e]=s(u[e]))})),!u.target&&!u.forward)return this.emit("error",new Error("Must provide a proper URL as target"));for(var p=0;p<a.length&&!a[p](r,o,u,n,this,i);p++);}}}function p(e){n.call(this),(e=e||{}).prependPath=!1!==e.prependPath,this.web=this.proxyRequest=u("web")(e),this.ws=this.proxyWebsocketRequest=u("ws")(e),this.options=e,this.webPasses=Object.keys(c).map((function(e){return c[e]})),this.wsPasses=Object.keys(h).map((function(e){return h[e]})),this.on("error",this.onError,this)}o.Server=p,o.createRightProxy=u,r(837).inherits(p,n),p.prototype.onError=function(e){if(1===this.listeners("error").length)throw e},p.prototype.listen=function(e,t){var r=this,o=function(e,t){r.web(e,t)};return this._server=this.options.ssl?a.createServer(this.options.ssl,o):i.createServer(o),this.options.ws&&this._server.on("upgrade",(function(e,t,o){r.ws(e,t,o)})),this._server.listen(e,t),this},p.prototype.close=function(e){var t=this;function r(){t._server=null,e&&e.apply(null,arguments)}this._server&&this._server.close(r)},p.prototype.before=function(e,t,r){if("ws"!==e&&"web"!==e)throw new Error("type must be `web` or `ws`");var o="ws"===e?this.wsPasses:this.webPasses,s=!1;if(o.forEach((function(e,r){e.name===t&&(s=r)})),!1===s)throw new Error("No such pass");o.splice(s,0,r)},p.prototype.after=function(e,t,r){if("ws"!==e&&"web"!==e)throw new Error("type must be `web` or `ws`");var o="ws"===e?this.wsPasses:this.webPasses,s=!1;if(o.forEach((function(e,r){e.name===t&&(s=r)})),!1===s)throw new Error("No such pass");o.splice(s++,0,r)}},101:(e,t,r)=>{var o=r(685),s=r(687),n=r(445),i=r(341),a=r(900);n=Object.keys(n).map((function(e){return n[e]}));var c={http:o,https:s};
/*!
 * Array of passes.
 *
 ...
 * flexible.
 */e.exports={deleteLength:function(e,t,r){"DELETE"!==e.method&&"OPTIONS"!==e.method||void 0!==e.headers["content-length"]||void 0!==e.headers["transfer-encoding"]||(e.headers["content-length"]="0")},timeout:function(e,t,r){r.timeout&&e.socket.setTimeout(r.timeout)},XHeaders:function(e,t,r){if(r.xfwd){var o=e.isSpdy||i.hasEncryptedConnection(e),s={for:e.connection.remoteAddress||e.socket.remoteAddress,port:i.getPort(e),proto:o?"https":"http"};["for","port","proto"].forEach((function(t){e.headers["x-forwarded-"+t]=(e.headers["x-forwarded-"+t]||"")+(e.headers["x-forwarded-"+t]?",":"")+s[t]})),e.headers["x-forwarded-host"]=e.headers["x-forwarded-host"]||e.headers.host||""}},stream:function(e,t,r,o,s,h){s.emit("start",e,t,r.target||r.forward);var u=r.followRedirects?a:c,p=u.http,f=u.https;if(r.forward){var d=("https:"===r.forward.protocol?f:p).request(i.setupOutgoing(r.ssl||{},r,e,"forward")),l=w(d,r.forward);if(e.on("error",l),d.on("error",l),(r.buffer||e).pipe(d),!r.target)return t.end()}var v=("https:"===r.target.protocol?f:p).request(i.setupOutgoing(r.ssl||{},r,e));v.on("socket",(function(o){s&&!v.getHeader("expect")&&s.emit("proxyReq",v,e,t,r)})),r.proxyTimeout&&v.setTimeout(r.proxyTimeout,(function(){v.abort()})),e.on("aborted",(function(){v.abort()}));var y=w(v,r.target);function w(r,o){return function(n){if(e.socket.destroyed&&"ECONNRESET"===n.code)return s.emit("econnreset",n,e,t,o),r.abort();h?h(n,e,t,o):s.emit("error",n,e,t,o)}}e.on("error",y),v.on("error",y),(r.buffer||e).pipe(v),v.on("response",(function(o){if(s&&s.emit("proxyRes",o,e,t),!t.headersSent&&!r.selfHandleResponse)for(var i=0;i<n.length&&!n[i](e,t,o,r);i++);t.finished?s&&s.emit("end",e,t,o):(o.on("end",(function(){s&&s.emit("end",e,t,o)})),r.selfHandleResponse||o.pipe(t))}))}}},445:(e,t,r)=>{var o=r(310),s=r(341),n=/^201|30(1|2|7|8)$/;
/*!
 * Array of passes.
 *
 * A `pass` is just a function that is executed on `req, res, options`
