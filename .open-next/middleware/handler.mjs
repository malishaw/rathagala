...
var BuildId = "SAnbNVwrqW2hfqEKy6hFu";
...
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/src/middleware.js"], "name": "src/middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next|[^?]*\\.(?:html?|css|js(?!on)|jpe?g|webp|png|gif|svg|ttf|woff2?|ico|csv|docx?|xlsx?|zip|webmanifest)).*))(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "originalSource": "/((?!_next|[^?]*\\.(?:html?|css|js(?!on)|jpe?g|webp|png|gif|svg|ttf|woff2?|ico|csv|docx?|xlsx?|zip|webmanifest)).*)" }, { "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/(api|trpc))(.*)(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "originalSource": "/(api|trpc)(.*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "SAnbNVwrqW2hfqEKy6hFu", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "rX/1BZwPO7yMEWfPWxy9C/9O+d2Y4exbjJit8g8Z1uo=", "__NEXT_PREVIEW_MODE_ID": "9717e30201b8cdffa9dd615d1444c102", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "55f2c57672e43e66810d6556a5691d1b2dc5378e48a236dfec68fc2a7735d0a4", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "438e0b7bc214e4f0a0e6033220bb2584a919ff5e118538a3eac34ce39343c7a2" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/icon.png/route": "/icon.png", "/api/admin/backup/clear/route": "/api/admin/backup/clear", "/api/admin/locations/cities/[id]/route": "/api/admin/locations/cities/[id]", "/api/admin/backup/export/route": "/api/admin/backup/export", "/api/[...route]/route": "/api/[...route]", "/api/auth/[...all]/route": "/api/auth/[...all]", "/api/manufacture-years/route": "/api/manufacture-years", "/api/admin/manufacture-years/route": "/api/admin/manufacture-years", "/api/plaiceholder/route": "/api/plaiceholder", "/api/admin/backup/import/route": "/api/admin/backup/import", "/api/admin/backup/verify-password/route": "/api/admin/backup/verify-password", "/api/admin/locations/cities/route": "/api/admin/locations/cities", "/api/admin/locations/districts/route": "/api/admin/locations/districts", "/api/admin/locations/districts/[id]/route": "/api/admin/locations/districts/[id]", "/api/admin/locations/provinces/[id]/route": "/api/admin/locations/provinces/[id]", "/api/admin/locations/provinces/route": "/api/admin/locations/provinces", "/api/admin/locations/seed/route": "/api/admin/locations/seed", "/api/admin/media/bulk-delete/route": "/api/admin/media/bulk-delete", "/api/admin/manufacture-years/seed/route": "/api/admin/manufacture-years/seed", "/api/admin/media/replace/route": "/api/admin/media/replace", "/api/admin/media/rename/route": "/api/admin/media/rename", "/api/admin/users/delete/route": "/api/admin/users/delete", "/api/admin/media/route": "/api/admin/media", "/api/check-ad-notifications/route": "/api/check-ad-notifications", "/api/market-price/route": "/api/market-price", "/api/similar-vehicles/route": "/api/similar-vehicles", "/api/admin/manufacture-years/[id]/route": "/api/admin/manufacture-years/[id]", "/api/admin/backup/stats/route": "/api/admin/backup/stats", "/api/locations/route": "/api/locations", "/api/media/delete/route": "/api/media/delete", "/api/media/upload/route": "/api/media/upload", "/api/watermark/route": "/api/watermark", "/(frontend)/(auth)/email-verified/page": "/email-verified", "/(frontend)/(auth)/signin/page": "/signin", "/(frontend)/(auth)/verify-email/page": "/verify-email", "/(frontend)/(landing)/[id]/page": "/[id]", "/(frontend)/(landing)/auto-parts/page": "/auto-parts", "/(frontend)/(auth)/forgot-password/page": "/forgot-password", "/(frontend)/(landing)/analyse/page": "/analyse", "/(frontend)/(landing)/contact/page": "/contact", "/(frontend)/(landing)/compare/page": "/compare", "/(frontend)/(auth)/setup-organization/page": "/setup-organization", "/(frontend)/(landing)/edit-ad/[id]/page": "/edit-ad/[id]", "/(frontend)/(landing)/brands/[name]/page": "/brands/[name]", "/(frontend)/(landing)/organizations/[id]/page": "/organizations/[id]", "/(frontend)/(landing)/rent/page": "/rent", "/(frontend)/(landing)/hire/page": "/hire", "/(frontend)/(landing)/boost/page": "/boost", "/(frontend)/(landing)/profile/page": "/profile", "/(frontend)/(landing)/about/page": "/about", "/(frontend)/(landing)/privacy/page": "/privacy", "/(frontend)/(landing)/sell/page": "/sell", "/(frontend)/(landing)/search/page": "/search", "/(frontend)/(landing)/ads/[...slug]/page": "/ads/[...slug]", "/(frontend)/dashboard/backup/page": "/dashboard/backup", "/(frontend)/(landing)/sell/new/page": "/sell/new", "/(frontend)/(landing)/want/page": "/want", "/(frontend)/dashboard/ads-manage/page": "/dashboard/ads-manage", "/(frontend)/dashboard/carousel/page": "/dashboard/carousel", "/(frontend)/dashboard/deleted-ads/page": "/dashboard/deleted-ads", "/(frontend)/(landing)/terms/page": "/terms", "/(frontend)/dashboard/auto-parts/page": "/dashboard/auto-parts", "/(frontend)/dashboard/newsletter/page": "/dashboard/newsletter", "/(frontend)/dashboard/media/page": "/dashboard/media", "/(frontend)/dashboard/models/page": "/dashboard/models", "/(frontend)/dashboard/manufacture-years/page": "/dashboard/manufacture-years", "/(frontend)/dashboard/organizations/page": "/dashboard/organizations", "/(frontend)/dashboard/expired-ads/page": "/dashboard/expired-ads", "/(frontend)/(landing)/page": "/", "/(frontend)/dashboard/report/page": "/dashboard/report", "/(frontend)/dashboard/address/page": "/dashboard/address", "/(frontend)/dashboard/ads/page": "/dashboard/ads", "/(frontend)/dashboard/organizations/[id]/page": "/dashboard/organizations/[id]", "/(frontend)/dashboard/page": "/dashboard", "/(frontend)/dashboard/promotion/page": "/dashboard/promotion", "/(frontend)/dashboard/users/page": "/dashboard/users", "/(frontend)/dashboard/ads/new/page": "/dashboard/ads/new", "/(frontend)/dashboard/revenue/page": "/dashboard/revenue", "/(frontend)/dashboard/reports/page": "/dashboard/reports", "/(frontend)/dashboard/grades/page": "/dashboard/grades", "/(frontend)/dashboard/ads/[id]/page": "/dashboard/ads/[id]", "/(frontend)/(auth)/signup/page": "/signup", "/(frontend)/(auth)/reset-password/page": "/reset-password" };
