...
var BuildId = "iEdi_AlY5eDSfZu1Dks5d";
...
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/src/middleware.js"], "name": "src/middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next|[^?]*\\.(?:html?|css|js(?!on)|jpe?g|webp|png|gif|svg|ttf|woff2?|ico|csv|docx?|xlsx?|zip|webmanifest)).*))(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "originalSource": "/((?!_next|[^?]*\\.(?:html?|css|js(?!on)|jpe?g|webp|png|gif|svg|ttf|woff2?|ico|csv|docx?|xlsx?|zip|webmanifest)).*)" }, { "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/(api|trpc))(.*)(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "originalSource": "/(api|trpc)(.*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "iEdi_AlY5eDSfZu1Dks5d", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "4F3CKw03xz1lzjBo4x79zuRCHhrUuMgRAcO3/m4cJO0=", "__NEXT_PREVIEW_MODE_ID": "d872384379071913ec5ffbf9f6c2cef7", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "6b73f386d36a91aa2c838e0675e3fd78fbd686b6ded0c38cdd0103759a12bc35", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "afaca7f1454ce4f7faab0c8592fff88bbaacc680dc46a36cace8bbf080a84c46" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/icon.png/route": "/icon.png", "/api/admin/backup/export/route": "/api/admin/backup/export", "/api/admin/backup/clear/route": "/api/admin/backup/clear", "/api/[...route]/route": "/api/[...route]", "/api/admin/locations/cities/[id]/route": "/api/admin/locations/cities/[id]", "/api/admin/locations/cities/route": "/api/admin/locations/cities", "/api/admin/backup/verify-password/route": "/api/admin/backup/verify-password", "/api/admin/locations/districts/[id]/route": "/api/admin/locations/districts/[id]", "/api/admin/locations/provinces/[id]/route": "/api/admin/locations/provinces/[id]", "/api/admin/backup/import/route": "/api/admin/backup/import", "/api/admin/locations/districts/route": "/api/admin/locations/districts", "/api/admin/locations/provinces/route": "/api/admin/locations/provinces", "/api/admin/locations/seed/route": "/api/admin/locations/seed", "/api/admin/media/replace/route": "/api/admin/media/replace", "/api/admin/media/route": "/api/admin/media", "/api/admin/users/delete/route": "/api/admin/users/delete", "/api/admin/media/bulk-delete/route": "/api/admin/media/bulk-delete", "/api/admin/media/rename/route": "/api/admin/media/rename", "/api/admin/manufacture-years/seed/route": "/api/admin/manufacture-years/seed", "/api/market-price/route": "/api/market-price", "/api/auth/[...all]/route": "/api/auth/[...all]", "/api/manufacture-years/route": "/api/manufacture-years", "/api/admin/manufacture-years/[id]/route": "/api/admin/manufacture-years/[id]", "/api/admin/manufacture-years/route": "/api/admin/manufacture-years", "/api/admin/backup/stats/route": "/api/admin/backup/stats", "/api/locations/route": "/api/locations", "/api/similar-vehicles/route": "/api/similar-vehicles", "/api/check-ad-notifications/route": "/api/check-ad-notifications", "/api/media/delete/route": "/api/media/delete", "/api/media/file/[...key]/route": "/api/media/file/[...key]", "/api/media/upload/route": "/api/media/upload", "/api/plaiceholder/route": "/api/plaiceholder", "/api/auth/check-email/route": "/api/auth/check-email", "/api/watermark/route": "/api/watermark", "/(frontend)/(auth)/email-verified/page": "/email-verified", "/(frontend)/(auth)/forgot-password/page": "/forgot-password", "/(frontend)/(landing)/analyse/page": "/analyse", "/(frontend)/(auth)/setup-organization/page": "/setup-organization", "/(frontend)/(landing)/[id]/page": "/[id]", "/(frontend)/(landing)/about/page": "/about", "/(frontend)/(auth)/verify-email/page": "/verify-email", "/(frontend)/(auth)/signin/page": "/signin", "/(frontend)/(landing)/auto-parts/page": "/auto-parts", "/(frontend)/(landing)/organizations/[id]/page": "/organizations/[id]", "/(frontend)/(landing)/hire/page": "/hire", "/(frontend)/(landing)/page": "/", "/(frontend)/(landing)/contact/page": "/contact", "/(frontend)/(landing)/compare/page": "/compare", "/(frontend)/(landing)/sell/new/page": "/sell/new", "/(frontend)/(landing)/brands/[name]/page": "/brands/[name]", "/(frontend)/(landing)/search/page": "/search", "/(frontend)/(landing)/rent/page": "/rent", "/(frontend)/(landing)/privacy/page": "/privacy", "/(frontend)/(landing)/sell/page": "/sell", "/(frontend)/(landing)/profile/page": "/profile", "/(frontend)/(landing)/want/page": "/want", "/(frontend)/(landing)/boost/page": "/boost", "/(frontend)/(landing)/edit-ad/[id]/page": "/edit-ad/[id]", "/(frontend)/(landing)/ads/[...slug]/page": "/ads/[...slug]", "/(frontend)/dashboard/ads/[id]/page": "/dashboard/ads/[id]", "/(frontend)/dashboard/address/page": "/dashboard/address", "/(frontend)/dashboard/auto-parts/page": "/dashboard/auto-parts", "/(frontend)/dashboard/ads/new/page": "/dashboard/ads/new", "/(frontend)/(landing)/terms/page": "/terms", "/(frontend)/dashboard/backup/page": "/dashboard/backup", "/(frontend)/dashboard/carousel/page": "/dashboard/carousel", "/(frontend)/dashboard/ads-manage/page": "/dashboard/ads-manage", "/(frontend)/dashboard/deleted-ads/page": "/dashboard/deleted-ads", "/(frontend)/dashboard/ads/page": "/dashboard/ads", "/(frontend)/dashboard/models/page": "/dashboard/models", "/(frontend)/dashboard/promotion/page": "/dashboard/promotion", "/(frontend)/dashboard/grades/page": "/dashboard/grades", "/(frontend)/dashboard/organizations/page": "/dashboard/organizations", "/(frontend)/dashboard/organizations/[id]/page": "/dashboard/organizations/[id]", "/(frontend)/dashboard/media/page": "/dashboard/media", "/(frontend)/dashboard/expired-ads/page": "/dashboard/expired-ads", "/(frontend)/dashboard/report/page": "/dashboard/report", "/(frontend)/dashboard/reports/page": "/dashboard/reports", "/(frontend)/dashboard/newsletter/page": "/dashboard/newsletter", "/(frontend)/dashboard/users/page": "/dashboard/users", "/(frontend)/dashboard/revenue/page": "/dashboard/revenue", "/(frontend)/dashboard/page": "/dashboard", "/(frontend)/dashboard/manufacture-years/page": "/dashboard/manufacture-years", "/(frontend)/(auth)/reset-password/page": "/reset-password", "/(frontend)/(auth)/signup/page": "/signup" };
