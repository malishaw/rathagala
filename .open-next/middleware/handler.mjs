...
var BuildId = "o8W2MlUKSVwFGQHDk0CGJ";
...
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/src/middleware.js"], "name": "src/middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next|[^?]*\\.(?:html?|css|js(?!on)|jpe?g|webp|png|gif|svg|ttf|woff2?|ico|csv|docx?|xlsx?|zip|webmanifest)).*))(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "originalSource": "/((?!_next|[^?]*\\.(?:html?|css|js(?!on)|jpe?g|webp|png|gif|svg|ttf|woff2?|ico|csv|docx?|xlsx?|zip|webmanifest)).*)" }, { "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/(api|trpc))(.*)(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "originalSource": "/(api|trpc)(.*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "o8W2MlUKSVwFGQHDk0CGJ", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "g0Oo2e2R02eMyrnxZSdtVG+FrNGvEy9yFNUAcCNUpCs=", "__NEXT_PREVIEW_MODE_ID": "ccde77b09f9acbbb27d235d2893396f1", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "1eab96df62dd1f8c5d276ce61f7f06dd5027a8938c1c04da1c98d3e46e8426be", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "8d5070d7313cc493bf6123db7d08d9a0be9daac22c6c74201248aa7b588208da" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/icon.png/route": "/icon.png", "/api/admin/backup/export/route": "/api/admin/backup/export", "/api/admin/backup/stats/route": "/api/admin/backup/stats", "/api/[...route]/route": "/api/[...route]", "/api/admin/backup/clear/route": "/api/admin/backup/clear", "/api/admin/backup/import/route": "/api/admin/backup/import", "/api/admin/locations/cities/route": "/api/admin/locations/cities", "/api/admin/locations/districts/[id]/route": "/api/admin/locations/districts/[id]", "/api/admin/locations/provinces/[id]/route": "/api/admin/locations/provinces/[id]", "/api/admin/backup/verify-password/route": "/api/admin/backup/verify-password", "/api/admin/locations/districts/route": "/api/admin/locations/districts", "/api/admin/locations/provinces/route": "/api/admin/locations/provinces", "/api/admin/locations/seed/route": "/api/admin/locations/seed", "/api/admin/manufacture-years/seed/route": "/api/admin/manufacture-years/seed", "/api/admin/media/replace/route": "/api/admin/media/replace", "/api/admin/media/rename/route": "/api/admin/media/rename", "/api/admin/media/bulk-delete/route": "/api/admin/media/bulk-delete", "/api/admin/media/route": "/api/admin/media", "/api/admin/users/delete/route": "/api/admin/users/delete", "/api/similar-vehicles/route": "/api/similar-vehicles", "/api/market-price/route": "/api/market-price", "/api/auth/[...all]/route": "/api/auth/[...all]", "/api/check-ad-notifications/route": "/api/check-ad-notifications", "/api/admin/manufacture-years/[id]/route": "/api/admin/manufacture-years/[id]", "/api/manufacture-years/route": "/api/manufacture-years", "/api/admin/manufacture-years/route": "/api/admin/manufacture-years", "/api/admin/locations/cities/[id]/route": "/api/admin/locations/cities/[id]", "/api/media/delete/route": "/api/media/delete", "/api/plaiceholder/route": "/api/plaiceholder", "/api/locations/route": "/api/locations", "/api/watermark/route": "/api/watermark", "/api/media/upload/route": "/api/media/upload", "/(frontend)/(auth)/setup-organization/page": "/setup-organization", "/(frontend)/(auth)/signin/page": "/signin", "/(frontend)/(auth)/email-verified/page": "/email-verified", "/(frontend)/(auth)/verify-email/page": "/verify-email", "/(frontend)/(landing)/ads/[...slug]/page": "/ads/[...slug]", "/(frontend)/(landing)/analyse/page": "/analyse", "/(frontend)/(landing)/brands/[name]/page": "/brands/[name]", "/(frontend)/(landing)/auto-parts/page": "/auto-parts", "/(frontend)/(landing)/about/page": "/about", "/(frontend)/(landing)/compare/page": "/compare", "/(frontend)/(landing)/contact/page": "/contact", "/(frontend)/(landing)/[id]/page": "/[id]", "/(frontend)/(auth)/forgot-password/page": "/forgot-password", "/(frontend)/(landing)/edit-ad/[id]/page": "/edit-ad/[id]", "/(frontend)/(landing)/organizations/[id]/page": "/organizations/[id]", "/(frontend)/(landing)/page": "/", "/(frontend)/(landing)/privacy/page": "/privacy", "/(frontend)/(landing)/profile/page": "/profile", "/(frontend)/(landing)/sell/new/page": "/sell/new", "/(frontend)/(landing)/terms/page": "/terms", "/(frontend)/(landing)/rent/page": "/rent", "/(frontend)/(landing)/boost/page": "/boost", "/(frontend)/dashboard/ads-manage/page": "/dashboard/ads-manage", "/(frontend)/dashboard/ads/[id]/page": "/dashboard/ads/[id]", "/(frontend)/dashboard/ads/page": "/dashboard/ads", "/(frontend)/(landing)/sell/page": "/sell", "/(frontend)/(landing)/search/page": "/search", "/(frontend)/(landing)/hire/page": "/hire", "/(frontend)/(landing)/want/page": "/want", "/(frontend)/dashboard/auto-parts/page": "/dashboard/auto-parts", "/(frontend)/dashboard/address/page": "/dashboard/address", "/(frontend)/dashboard/backup/page": "/dashboard/backup", "/(frontend)/dashboard/grades/page": "/dashboard/grades", "/(frontend)/dashboard/manufacture-years/page": "/dashboard/manufacture-years", "/(frontend)/dashboard/carousel/page": "/dashboard/carousel", "/(frontend)/dashboard/ads/new/page": "/dashboard/ads/new", "/(frontend)/dashboard/organizations/[id]/page": "/dashboard/organizations/[id]", "/(frontend)/dashboard/deleted-ads/page": "/dashboard/deleted-ads", "/(frontend)/dashboard/newsletter/page": "/dashboard/newsletter", "/(frontend)/dashboard/expired-ads/page": "/dashboard/expired-ads", "/(frontend)/dashboard/media/page": "/dashboard/media", "/(frontend)/dashboard/organizations/page": "/dashboard/organizations", "/(frontend)/dashboard/page": "/dashboard", "/(frontend)/dashboard/models/page": "/dashboard/models", "/(frontend)/dashboard/reports/page": "/dashboard/reports", "/(frontend)/dashboard/promotion/page": "/dashboard/promotion", "/(frontend)/dashboard/revenue/page": "/dashboard/revenue", "/(frontend)/dashboard/report/page": "/dashboard/report", "/(frontend)/dashboard/users/page": "/dashboard/users", "/(frontend)/(auth)/signup/page": "/signup", "/(frontend)/(auth)/reset-password/page": "/reset-password" };
