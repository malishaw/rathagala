...
var BuildId = "ItK2F-wuWbaCLAVl6kKex";
...
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/src/middleware.js"], "name": "src/middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next|[^?]*\\.(?:html?|css|js(?!on)|jpe?g|webp|png|gif|svg|ttf|woff2?|ico|csv|docx?|xlsx?|zip|webmanifest)).*))(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "originalSource": "/((?!_next|[^?]*\\.(?:html?|css|js(?!on)|jpe?g|webp|png|gif|svg|ttf|woff2?|ico|csv|docx?|xlsx?|zip|webmanifest)).*)" }, { "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/(api|trpc))(.*)(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "originalSource": "/(api|trpc)(.*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "ItK2F-wuWbaCLAVl6kKex", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "cV83XsoOYPtKQpAGzFLHQUY15KbGmWA1f3Vv7gWerBw=", "__NEXT_PREVIEW_MODE_ID": "19c180ab07d98f1dc7e70b5d6fcabadf", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "f38b91c7eb6ad6734e209b265722a756b74bca3630f1fbbb8ddaee83bdadc60b", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "5fe13d44f5d2e072e3dcac29211fa6217ff480e5f360eefcec436cea92802a24" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/icon.png/route": "/icon.png", "/api/admin/backup/verify-password/route": "/api/admin/backup/verify-password", "/api/admin/backup/import/route": "/api/admin/backup/import", "/api/admin/locations/provinces/[id]/route": "/api/admin/locations/provinces/[id]", "/api/admin/locations/districts/[id]/route": "/api/admin/locations/districts/[id]", "/api/admin/locations/seed/route": "/api/admin/locations/seed", "/api/admin/locations/cities/route": "/api/admin/locations/cities", "/api/admin/locations/provinces/route": "/api/admin/locations/provinces", "/api/admin/manufacture-years/seed/route": "/api/admin/manufacture-years/seed", "/api/admin/media/rename/route": "/api/admin/media/rename", "/api/admin/media/bulk-delete/route": "/api/admin/media/bulk-delete", "/api/admin/media/replace/route": "/api/admin/media/replace", "/api/admin/media/route": "/api/admin/media", "/api/admin/users/delete/route": "/api/admin/users/delete", "/api/check-ad-notifications/route": "/api/check-ad-notifications", "/api/market-price/route": "/api/market-price", "/api/similar-vehicles/route": "/api/similar-vehicles", "/api/admin/backup/clear/route": "/api/admin/backup/clear", "/api/[...route]/route": "/api/[...route]", "/api/admin/locations/districts/route": "/api/admin/locations/districts", "/api/admin/locations/cities/[id]/route": "/api/admin/locations/cities/[id]", "/api/admin/backup/export/route": "/api/admin/backup/export", "/api/auth/[...all]/route": "/api/auth/[...all]", "/api/manufacture-years/route": "/api/manufacture-years", "/api/admin/manufacture-years/route": "/api/admin/manufacture-years", "/api/admin/manufacture-years/[id]/route": "/api/admin/manufacture-years/[id]", "/api/admin/backup/stats/route": "/api/admin/backup/stats", "/api/plaiceholder/route": "/api/plaiceholder", "/api/media/upload/route": "/api/media/upload", "/api/media/delete/route": "/api/media/delete", "/api/locations/route": "/api/locations", "/api/watermark/route": "/api/watermark", "/(frontend)/(auth)/setup-organization/page": "/setup-organization", "/(frontend)/(auth)/signin/page": "/signin", "/(frontend)/(landing)/ads/[...slug]/page": "/ads/[...slug]", "/(frontend)/(landing)/[id]/page": "/[id]", "/(frontend)/(landing)/boost/page": "/boost", "/(frontend)/(landing)/analyse/page": "/analyse", "/(frontend)/(auth)/forgot-password/page": "/forgot-password", "/(frontend)/(landing)/edit-ad/[id]/page": "/edit-ad/[id]", "/(frontend)/(landing)/contact/page": "/contact", "/(frontend)/(auth)/verify-email/page": "/verify-email", "/(frontend)/(landing)/organizations/[id]/page": "/organizations/[id]", "/(frontend)/(landing)/compare/page": "/compare", "/(frontend)/(auth)/email-verified/page": "/email-verified", "/(frontend)/(landing)/about/page": "/about", "/(frontend)/(landing)/privacy/page": "/privacy", "/(frontend)/(landing)/sell/new/page": "/sell/new", "/(frontend)/(landing)/search/page": "/search", "/(frontend)/(landing)/page": "/", "/(frontend)/(landing)/profile/page": "/profile", "/(frontend)/dashboard/address/page": "/dashboard/address", "/(frontend)/(landing)/want/page": "/want", "/(frontend)/(landing)/auto-parts/page": "/auto-parts", "/(frontend)/dashboard/ads/new/page": "/dashboard/ads/new", "/(frontend)/dashboard/ads/[id]/page": "/dashboard/ads/[id]", "/(frontend)/(landing)/rent/page": "/rent", "/(frontend)/dashboard/ads-manage/page": "/dashboard/ads-manage", "/(frontend)/(landing)/hire/page": "/hire", "/(frontend)/dashboard/carousel/page": "/dashboard/carousel", "/(frontend)/dashboard/grades/page": "/dashboard/grades", "/(frontend)/dashboard/auto-parts/page": "/dashboard/auto-parts", "/(frontend)/(landing)/brands/[name]/page": "/brands/[name]", "/(frontend)/dashboard/manufacture-years/page": "/dashboard/manufacture-years", "/(frontend)/dashboard/deleted-ads/page": "/dashboard/deleted-ads", "/(frontend)/dashboard/backup/page": "/dashboard/backup", "/(frontend)/dashboard/organizations/[id]/page": "/dashboard/organizations/[id]", "/(frontend)/dashboard/page": "/dashboard", "/(frontend)/(landing)/terms/page": "/terms", "/(frontend)/dashboard/report/page": "/dashboard/report", "/(frontend)/dashboard/newsletter/page": "/dashboard/newsletter", "/(frontend)/dashboard/expired-ads/page": "/dashboard/expired-ads", "/(frontend)/dashboard/organizations/page": "/dashboard/organizations", "/(frontend)/dashboard/media/page": "/dashboard/media", "/(frontend)/(landing)/sell/page": "/sell", "/(frontend)/dashboard/models/page": "/dashboard/models", "/(frontend)/dashboard/promotion/page": "/dashboard/promotion", "/(frontend)/dashboard/reports/page": "/dashboard/reports", "/(frontend)/dashboard/revenue/page": "/dashboard/revenue", "/(frontend)/dashboard/users/page": "/dashboard/users", "/(frontend)/dashboard/ads/page": "/dashboard/ads", "/(frontend)/(auth)/reset-password/page": "/reset-password", "/(frontend)/(auth)/signup/page": "/signup" };
