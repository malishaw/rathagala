...
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/src/middleware.js"], "name": "src/middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next|[^?]*\\.(?:html?|css|js(?!on)|jpe?g|webp|png|gif|svg|ttf|woff2?|ico|csv|docx?|xlsx?|zip|webmanifest)).*))(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "originalSource": "/((?!_next|[^?]*\\.(?:html?|css|js(?!on)|jpe?g|webp|png|gif|svg|ttf|woff2?|ico|csv|docx?|xlsx?|zip|webmanifest)).*)" }, { "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/(api|trpc))(.*)(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "originalSource": "/(api|trpc)(.*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "2rLOPXf9GZ_G5--lRa42X", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "HDpHYjGa+ncFl4ce6VvfLZ463CpSPlBYzmhSFuAdMio=", "__NEXT_PREVIEW_MODE_ID": "dd05284da9d6f6b357639bb4888e44e7", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "4b621acde1b72fba1555ff70a3101e0e4fbdf8614d43411db75d0b574820a1cf", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "c0b2914b714b0e0b2e2f9413a0bed3c606d741b01c78f12b6bf60ddb32aae127" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/icon.png/route": "/icon.png", "/api/admin/backup/import/route": "/api/admin/backup/import", "/api/admin/backup/verify-password/route": "/api/admin/backup/verify-password", "/api/admin/locations/cities/route": "/api/admin/locations/cities", "/api/admin/locations/districts/route": "/api/admin/locations/districts", "/api/admin/locations/districts/[id]/route": "/api/admin/locations/districts/[id]", "/api/admin/locations/provinces/[id]/route": "/api/admin/locations/provinces/[id]", "/api/admin/locations/provinces/route": "/api/admin/locations/provinces", "/api/admin/locations/seed/route": "/api/admin/locations/seed", "/api/admin/manufacture-years/seed/route": "/api/admin/manufacture-years/seed", "/api/admin/media/rename/route": "/api/admin/media/rename", "/api/admin/media/route": "/api/admin/media", "/api/admin/media/replace/route": "/api/admin/media/replace", "/api/admin/users/delete/route": "/api/admin/users/delete", "/api/check-ad-notifications/route": "/api/check-ad-notifications", "/api/market-price/route": "/api/market-price", "/api/admin/media/bulk-delete/route": "/api/admin/media/bulk-delete", "/api/admin/backup/clear/route": "/api/admin/backup/clear", "/api/[...route]/route": "/api/[...route]", "/api/admin/backup/export/route": "/api/admin/backup/export", "/api/admin/backup/stats/route": "/api/admin/backup/stats", "/api/auth/[...all]/route": "/api/auth/[...all]", "/api/admin/locations/cities/[id]/route": "/api/admin/locations/cities/[id]", "/api/admin/manufacture-years/route": "/api/admin/manufacture-years", "/api/manufacture-years/route": "/api/manufacture-years", "/api/locations/route": "/api/locations", "/api/plaiceholder/route": "/api/plaiceholder", "/api/similar-vehicles/route": "/api/similar-vehicles", "/api/media/delete/route": "/api/media/delete", "/api/admin/manufacture-years/[id]/route": "/api/admin/manufacture-years/[id]", "/api/media/upload/route": "/api/media/upload", "/api/watermark/route": "/api/watermark", "/(frontend)/(auth)/email-verified/page": "/email-verified", "/(frontend)/(auth)/signin/page": "/signin", "/(frontend)/(auth)/setup-organization/page": "/setup-organization", "/(frontend)/(landing)/[id]/page": "/[id]", "/(frontend)/(auth)/forgot-password/page": "/forgot-password", "/(frontend)/(landing)/about/page": "/about", "/(frontend)/(landing)/analyse/page": "/analyse", "/(frontend)/(auth)/verify-email/page": "/verify-email", "/(frontend)/(landing)/brands/[name]/page": "/brands/[name]", "/(frontend)/(landing)/boost/page": "/boost", "/(frontend)/(landing)/edit-ad/[id]/page": "/edit-ad/[id]", "/(frontend)/(landing)/hire/page": "/hire", "/(frontend)/(landing)/organizations/[id]/page": "/organizations/[id]", "/(frontend)/(landing)/auto-parts/page": "/auto-parts", "/(frontend)/(landing)/profile/page": "/profile", "/(frontend)/(landing)/page": "/", "/(frontend)/(landing)/ads/[...slug]/page": "/ads/[...slug]", "/(frontend)/(landing)/rent/page": "/rent", "/(frontend)/(landing)/contact/page": "/contact", "/(frontend)/(landing)/compare/page": "/compare", "/(frontend)/(landing)/sell/page": "/sell", "/(frontend)/dashboard/ads/page": "/dashboard/ads", "/(frontend)/dashboard/address/page": "/dashboard/address", "/(frontend)/dashboard/auto-parts/page": "/dashboard/auto-parts", "/(frontend)/dashboard/carousel/page": "/dashboard/carousel", "/(frontend)/(landing)/privacy/page": "/privacy", "/(frontend)/(landing)/sell/new/page": "/sell/new", "/(frontend)/(landing)/search/page": "/search", "/(frontend)/dashboard/expired-ads/page": "/dashboard/expired-ads", "/(frontend)/dashboard/grades/page": "/dashboard/grades", "/(frontend)/(landing)/terms/page": "/terms", "/(frontend)/dashboard/ads-manage/page": "/dashboard/ads-manage", "/(frontend)/dashboard/backup/page": "/dashboard/backup", "/(frontend)/dashboard/models/page": "/dashboard/models", "/(frontend)/(landing)/want/page": "/want", "/(frontend)/dashboard/media/page": "/dashboard/media", "/(frontend)/dashboard/deleted-ads/page": "/dashboard/deleted-ads", "/(frontend)/dashboard/promotion/page": "/dashboard/promotion", "/(frontend)/dashboard/report/page": "/dashboard/report", "/(frontend)/dashboard/organizations/[id]/page": "/dashboard/organizations/[id]", "/(frontend)/dashboard/users/page": "/dashboard/users", "/(frontend)/dashboard/page": "/dashboard", "/(frontend)/dashboard/newsletter/page": "/dashboard/newsletter", "/(frontend)/dashboard/ads/[id]/page": "/dashboard/ads/[id]", "/(frontend)/dashboard/organizations/page": "/dashboard/organizations", "/(frontend)/dashboard/manufacture-years/page": "/dashboard/manufacture-years", "/(frontend)/dashboard/ads/new/page": "/dashboard/ads/new", "/(frontend)/dashboard/reports/page": "/dashboard/reports", "/(frontend)/dashboard/revenue/page": "/dashboard/revenue", "/(frontend)/(auth)/reset-password/page": "/reset-password", "/(frontend)/(auth)/signup/page": "/signup" };
