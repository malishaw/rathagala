...
var BuildId = "w1VamQl-kEdMLa4Nzwyg4";
...
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/src/middleware.js"], "name": "src/middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next|[^?]*\\.(?:html?|css|js(?!on)|jpe?g|webp|png|gif|svg|ttf|woff2?|ico|csv|docx?|xlsx?|zip|webmanifest)).*))(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "originalSource": "/((?!_next|[^?]*\\.(?:html?|css|js(?!on)|jpe?g|webp|png|gif|svg|ttf|woff2?|ico|csv|docx?|xlsx?|zip|webmanifest)).*)" }, { "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/(api|trpc))(.*)(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "originalSource": "/(api|trpc)(.*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "w1VamQl-kEdMLa4Nzwyg4", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "cV83XsoOYPtKQpAGzFLHQUY15KbGmWA1f3Vv7gWerBw=", "__NEXT_PREVIEW_MODE_ID": "19c180ab07d98f1dc7e70b5d6fcabadf", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "f38b91c7eb6ad6734e209b265722a756b74bca3630f1fbbb8ddaee83bdadc60b", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "5fe13d44f5d2e072e3dcac29211fa6217ff480e5f360eefcec436cea92802a24" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/icon.png/route": "/icon.png", "/api/[...route]/route": "/api/[...route]", "/api/admin/backup/stats/route": "/api/admin/backup/stats", "/api/admin/backup/import/route": "/api/admin/backup/import", "/api/admin/locations/cities/route": "/api/admin/locations/cities", "/api/admin/backup/verify-password/route": "/api/admin/backup/verify-password", "/api/admin/locations/districts/[id]/route": "/api/admin/locations/districts/[id]", "/api/admin/locations/provinces/[id]/route": "/api/admin/locations/provinces/[id]", "/api/admin/locations/districts/route": "/api/admin/locations/districts", "/api/admin/locations/seed/route": "/api/admin/locations/seed", "/api/admin/locations/provinces/route": "/api/admin/locations/provinces", "/api/admin/media/bulk-delete/route": "/api/admin/media/bulk-delete", "/api/admin/media/replace/route": "/api/admin/media/replace", "/api/admin/manufacture-years/seed/route": "/api/admin/manufacture-years/seed", "/api/admin/media/rename/route": "/api/admin/media/rename", "/api/admin/users/delete/route": "/api/admin/users/delete", "/api/admin/media/route": "/api/admin/media", "/api/check-ad-notifications/route": "/api/check-ad-notifications", "/api/similar-vehicles/route": "/api/similar-vehicles", "/api/market-price/route": "/api/market-price", "/api/admin/backup/clear/route": "/api/admin/backup/clear", "/api/admin/backup/export/route": "/api/admin/backup/export", "/api/auth/[...all]/route": "/api/auth/[...all]", "/api/media/delete/route": "/api/media/delete", "/api/manufacture-years/route": "/api/manufacture-years", "/api/admin/locations/cities/[id]/route": "/api/admin/locations/cities/[id]", "/api/admin/manufacture-years/[id]/route": "/api/admin/manufacture-years/[id]", "/api/admin/manufacture-years/route": "/api/admin/manufacture-years", "/api/media/upload/route": "/api/media/upload", "/api/locations/route": "/api/locations", "/api/plaiceholder/route": "/api/plaiceholder", "/api/watermark/route": "/api/watermark", "/(frontend)/(landing)/[id]/page": "/[id]", "/(frontend)/(landing)/boost/page": "/boost", "/(frontend)/(landing)/auto-parts/page": "/auto-parts", "/(frontend)/(auth)/setup-organization/page": "/setup-organization", "/(frontend)/(landing)/about/page": "/about", "/(frontend)/(landing)/ads/[...slug]/page": "/ads/[...slug]", "/(frontend)/(auth)/verify-email/page": "/verify-email", "/(frontend)/(landing)/analyse/page": "/analyse", "/(frontend)/(auth)/email-verified/page": "/email-verified", "/(frontend)/(landing)/contact/page": "/contact", "/(frontend)/(landing)/brands/[name]/page": "/brands/[name]", "/(frontend)/(auth)/signin/page": "/signin", "/(frontend)/(landing)/hire/page": "/hire", "/(frontend)/(landing)/privacy/page": "/privacy", "/(frontend)/(landing)/rent/page": "/rent", "/(frontend)/(landing)/organizations/[id]/page": "/organizations/[id]", "/(frontend)/(landing)/sell/new/page": "/sell/new", "/(frontend)/(landing)/profile/page": "/profile", "/(frontend)/(landing)/edit-ad/[id]/page": "/edit-ad/[id]", "/(frontend)/(landing)/compare/page": "/compare", "/(frontend)/(landing)/search/page": "/search", "/(frontend)/(landing)/want/page": "/want", "/(frontend)/(landing)/page": "/", "/(frontend)/(landing)/sell/page": "/sell", "/(frontend)/dashboard/ads/page": "/dashboard/ads", "/(frontend)/dashboard/ads/[id]/page": "/dashboard/ads/[id]", "/(frontend)/(landing)/terms/page": "/terms", "/(frontend)/dashboard/ads/new/page": "/dashboard/ads/new", "/(frontend)/dashboard/deleted-ads/page": "/dashboard/deleted-ads", "/(frontend)/dashboard/ads-manage/page": "/dashboard/ads-manage", "/(frontend)/dashboard/expired-ads/page": "/dashboard/expired-ads", "/(frontend)/dashboard/address/page": "/dashboard/address", "/(frontend)/dashboard/auto-parts/page": "/dashboard/auto-parts", "/(frontend)/dashboard/organizations/page": "/dashboard/organizations", "/(frontend)/dashboard/media/page": "/dashboard/media", "/(frontend)/dashboard/organizations/[id]/page": "/dashboard/organizations/[id]", "/(frontend)/dashboard/models/page": "/dashboard/models", "/(frontend)/dashboard/page": "/dashboard", "/(frontend)/dashboard/newsletter/page": "/dashboard/newsletter", "/(frontend)/dashboard/grades/page": "/dashboard/grades", "/(frontend)/dashboard/backup/page": "/dashboard/backup", "/(frontend)/dashboard/promotion/page": "/dashboard/promotion", "/(frontend)/(auth)/forgot-password/page": "/forgot-password", "/(frontend)/dashboard/reports/page": "/dashboard/reports", "/(frontend)/dashboard/report/page": "/dashboard/report", "/(frontend)/dashboard/users/page": "/dashboard/users", "/(frontend)/dashboard/carousel/page": "/dashboard/carousel", "/(frontend)/dashboard/manufacture-years/page": "/dashboard/manufacture-years", "/(frontend)/dashboard/revenue/page": "/dashboard/revenue", "/(frontend)/(auth)/reset-password/page": "/reset-password", "/(frontend)/(auth)/signup/page": "/signup" };
