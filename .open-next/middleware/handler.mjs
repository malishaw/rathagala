...
var require_middleware = __commonJS({
  ".next/server/src/middleware.js"() {
    ...
    (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[550], { 165: (a, b, c) => {
      ...
      c.r(f), c.d(f, { config: () => bw, default: () => bv });
      let h = null;
      async function i() {
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      let bt = ["/signin", "/signup", "/reset-password", "/forgot-password", "/email-verified"], bu = ["/dashboard", "/profile"];
      function bv(a10) {
        let b2 = a10.nextUrl.pathname;
        if (bu.some((a11) => b2.startsWith(a11)) || bt.includes(b2)) {
          let c2 = a10.cookies.has("better-auth.session_token") || a10.cookies.has("__Secure-better-auth.session_token") || a10.cookies.has("__Host-better-auth.session_token") || a10.cookies.getAll().some((a11) => a11.name.includes("session_token"));
          if (bt.includes(b2) && c2) return S.redirect(new URL("/", a10.url));
          if (bu.some((a11) => b2.startsWith(a11)) && !c2) return S.redirect(new URL(`/signin?callbackUrl=${encodeURIComponent(b2)}`, a10.url));
        }
        return S.next();
      }
      let bw = { matcher: ["/((?!_next|[^?]*\\.(?:html?|css|js(?!on)|jpe?g|webp|png|gif|svg|ttf|woff2?|ico|csv|docx?|xlsx?|zip|webmanifest)).*)", "/(api|trpc)(.*)"] };
